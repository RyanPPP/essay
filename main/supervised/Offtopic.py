...
class Detection:
    ...
    def GlobalWater(self,text):
        countVec = joblib.load(os.getcwd()+'/main/supervised/GWdetection_count.pkl')
        Tfidf = joblib.load(os.getcwd()+'/main/supervised/GWdetection_tfidf.pkl')
        Model = joblib.load(os.getcwd()+'/main/supervised/GWdetection_model.pkl')
    ...
    def HasteWaste(self,text):
        countVec = joblib.load(os.getcwd()+'/main/supervised/HWdetection_count.pkl')
        Tfidf = joblib.load(os.getcwd()+'/main/supervised/HWdetection_tfidf.pkl')
        Model = joblib.load(os.getcwd()+'/main/supervised/HWdetection_model.pkl')
        x_count = countVec.transform(text)
        x_tfidf = Tfidf.transform(x_count)
        predict = Model.predict(x_tfidf)
        return self.target_names[int(predict)]
