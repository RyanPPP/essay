...
from NBscore import Score as sc
from OffTopic import Detection as de
from check import check
from supervised import Offtopic as offtopic
...
def wait(request):
    ...
    if request.POST:
        ...
        result['sign']= request.POST['sign']
        result['record_id'] = request.POST['record_id']
