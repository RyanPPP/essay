...
class Detector:
    # model = gensim.models.Word2Vec.load_word2vec_format("main/OffTopic/TitleExpanding/word2vec/wiki.en.text_50.vector", binary=False)
    def __init__(self,title):
        self.title = title
        #载入模型
        # self.model = gensim.models.Word2Vec.load_word2vec_format("main/OffTopic/TitleExpanding/word2vec/wiki.en.text_50.vector", binary=False)
        print 'model loaded!'
        # 预处理题目
        ...
        print '-------------------------'
        # 读取停用词表
        stopwords = open('main/OffTopic/KeyWord/LDA/preprocess/stopwords.txt', 'r')
    ...
    def LDA_keyword(self):
        ...
        themePath = 'main/OffTopic/KeyWord/LDA/data/tmp/model_theta.dat'
        theme_word_path = 'main/OffTopic/KeyWord/LDA/data/tmp/model_twords.dat'
        keywords_path = 'main/OffTopic/KeyWord/LDA/data/tmp/main.txt'
    ...
    def offtopic_detect(self,article,method):
        ...
        if len(distinctWord)< 30:
            ...
            # print '::::::::::::::::::::::::::::::::::',os.getcwd()
            # path1=os.getcwd()+"/main/OffTopic/KeyWord/LDA/data/train.dat"
            f = open(os.getcwd()+"/main/OffTopic/KeyWord/LDA/data/train.dat", 'w')
